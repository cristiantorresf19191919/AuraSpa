...
// Enhanced animation variants with scroll-triggered effects
    ...
    return (
        <Box sx={{
            ...
            <Container maxWidth="lg">
                ...
                {/* Why Join Section - Scroll-triggered with staggering */}
                <ScrollAnimatedSection variants={staggerContainerVariants}>
                    <Box sx={{ mb: 12 }}>
                        ...
                        {/* Enhanced Benefits Grid with individual scroll animations */}
                ...
                {/* Steps Section - Enhanced scroll animations */}
                <ScrollAnimatedSection variants={staggerContainerVariants}>
                    <Box sx={{ mb: 12 }}>
                        <motion.div
                            variants={fadeInUpVariants}
                ...
                {/* What You Gain Section - Enhanced scroll animations */}
                <ScrollAnimatedSection variants={staggerContainerVariants}>
                    <Box sx={{ mb: 12 }}>
                        <motion.div
                            variants={fadeInUpVariants}
                ...
                {/* Final CTA Section - Enhanced scroll animations */}
                <ScrollAnimatedSection variants={fadeInUpVariants}>
                    <Box sx={{
                        textAlign: 'center',
                        mb: 12,
                ...
                {/* Back to Home - Enhanced scroll animations */}
