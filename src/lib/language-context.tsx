...
const translations = {
    en: {
        ...
        // Onboarding
        'welcome.to.aura': '✨ Welcome to AURA ✨',
        'join.thousands.professionals': '🚀 Join thousands of wellness professionals and start your journey to success!',
        ...
        'placeholder.city': 'e.g., Bogotá, Medellín, Cali',
    ...
    es: {
        ...
        'discover.therapists': 'Descubre terapeutas profesionales de masajes y reserva tu sesión de relajación hoy. Desde Sueco hasta Tejido Profundo, encuentra el tratamiento perfecto para tus necesidades.',
        ...
        'satisfaction.assured': 'Satisfacción Garantizada',
        ...
        'discover.therapies': 'Descubre una amplia gama de servicios profesionales diseñados para ayudarte a relajarte, curar y rejuvenecer',
        ...
        'try.adjusting': 'Intenta ajustar tus criterios de búsqueda o explorar todas las categorías',
        'clear.filters': 'Limpiar Filtros',
        'sign.in.to.book': 'Inicia Sesión para Reservar',

        // Dashboard
        'welcome.back.name': '¡Bienvenido de vuelta, {name}!',
        'manage.services.appointments': 'Gestiona tus servicios y citas',
        'view.appointments.history': 'Ve tus próximas citas y historial de reservas',
        ...
        'drag.drop.image': 'Arrastra y suelta una imagen aquí, o haz clic para seleccionar',
        'image.preview': 'Vista Previa de Imagen',
        'service.details': 'Detalles del Servicio',
        'pricing.duration': 'Precio y Duración',
        'visibility.settings': 'Configuración de Visibilidad',
        ...
        'appointment.booked': 'Tu cita ha sido reservada exitosamente. Recibirás un correo de confirmación pronto.',
        ...
        // Onboarding
        'welcome.to.aura': '✨ ¡Bienvenido a AURA ✨',
        'join.thousands.professionals': '🚀 ¡Únete a miles de profesionales del bienestar y comienza tu camino al éxito!',
        'complete.profile.steps': 'Completa tu perfil en solo unos pasos',
        'your.foundation': 'Tu Fundación',
        'your.professional.showcase': 'Tu Vitrina Profesional',
        'your.practice': 'Tu Práctica',
        'personal.details': 'Detalles Personales',
        'foundation.description': 'Comencemos con tu información básica para crear tu cuenta y establecer tu fundación en nuestra plataforma.',
        'professional.showcase.description': 'Construye tu perfil profesional público para atraer clientes y mostrar tu experiencia.',
        'practice.description': 'Define los detalles logísticos para las reservas de clientes y pagos.',
        ...
        'drag.drop.profile': 'Arrastra y suelta tu foto de perfil aquí, o haz clic para seleccionar',
        ...
        'validation.confirmpassword.required': 'Por favor confirma tu contraseña',
        ...
        'validation.aboutme.required': 'Acerca de mí es requerido',
        'validation.aboutme.min': 'Acerca de mí debe tener al menos 50 caracteres',
        ...
        'validation.areas.required': 'Por favor agrega al menos un área de servicio',
        ...
        'placeholder.confirm.password': 'Confirma tu contraseña',
        'placeholder.professional.title': 'ej., Terapeuta de Masajes Licenciado, Especialista en Bienestar',
        'placeholder.about.me': 'Cuéntales a los clientes sobre tu experiencia, especialidades y enfoque al bienestar...',
        'placeholder.city': 'ej., Bogotá, Medellín, Cali',
    }
};
